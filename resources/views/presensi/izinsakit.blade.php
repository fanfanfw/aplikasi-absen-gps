                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-icon mb-3">
                              ...
                              <input type="text" name="dari" value="{{ Request('dari') }}" class="form-control" id="dari" placeholder="Dari">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="input-icon mb-3">
                              ...
                              <input type="text" name="sampai" value="{{ Request('sampai') }}" class="form-control" id="sampai" placeholder="Sampai">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            ...
                            <input type="text" name="nik" value="{{ Request('nik') }}" class="form-control" id="nik" placeholder="NIK">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-icon mb-3">
                            ...
                            <input type="text" name="nama_lengkap" value="{{ Request('nama_lengkap') }}" class="form-control" id="nama_lengkap" placeholder="Nama Karyawan">
                            </div>
                        </div>
                        <div class="col-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($d->status_approved==1)
                                        <span class="badge bg-success" style="">Disetujui</span>
